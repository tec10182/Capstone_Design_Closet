...
def predict_dense_pose_map(storage_root: str, img_name: str):
    # det2 패키지로 동일한 결과를 출력하기 위해 일종의 치트를 사용
    os.chdir("./model/tryon/densepose")
    ...
    image_path = osp.join(storage_root, "tryon/raw_data/person", img_name)
    ...
    save_path = osp.join(storage_root, "tryon/preprocess/densepose", img_name)
    save_state = False
