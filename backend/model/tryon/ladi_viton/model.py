...
from model.tryon.ladi_viton.models.AutoencoderKL import AutoencoderKL
from model.tryon.ladi_viton.utils.encode_text_word_embedding import encode_text_word_embedding
from model.tryon.ladi_viton.utils.set_seeds import set_seed
from model.tryon.ladi_viton.vto_pipelines.tryon_pipe import StableDiffusionTryOnePipeline

from model.tryon.ladi_viton.utils.labelmap import LIP_map
from model.tryon.ladi_viton.utils.posemap import kpoint_to_heatmap
from model.tryon.ladi_viton.utils.posemap import get_coco_body25_mapping
...
def ladi_inference(storage_root: str , p_img_name: str ,c_img_name: str , category: str):
    ladi_vton = LadiVton()
