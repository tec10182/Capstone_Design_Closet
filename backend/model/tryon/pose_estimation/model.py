...
class OpenPoseBody25():
    def __init__(self):
        ...
        my_path = "C:\\Users\\han\\PycharmProjects\\Backend\\Capstone_Design_Closet\\backend\model\\tryon\\pose_estimation\\src\\"
        self.proto_file = my_path + "pose_deploy.prototxt"
        self.weights_file = my_path + "pose_iter_584000.caffemodel"
    ...
    def pose_estimation(self, storage: str, img, img_info, model_name: str):
        ...
        if model_name == 'hr-viton':
            ...
            img_path = osp.join(storage, 'tryon/preprocess/pose/img', f'{img_info[2]}.png')
    ...
    def make_json(self, storage, pose, save_name):
        ...
        # 저장
        kpts_path = osp.join(storage, 'tryon/preprocess/pose/keypoints', f'{save_name}.json')
    ...
    def inference(self, storage_root: str, img_name: str, model_name: str):
        ...
        mask_path = osp.join(storage_root, 'tryon/preprocess/mask/person', img_name)
...
def predict_pose_kpts(storage_root: str, img_name: str):
    body25 = OpenPoseBody25()
    save_state = body25.inference(storage_root, img_name, 'hr-viton')
